...
Make sure to download the CIFAR-10 dataset and run cifar10_data_export_verification.py to ensure the fortran program is loading the python dataset correctly.

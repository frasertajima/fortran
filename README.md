...
5. medfit example: Both Fortran 77 and refactored modern Fortran. Added csv handling and fixed a ran1.f error in Fortran 77 that occured using the nvfortran compiler; refactoring ran1.f fixed the error.
